...
public class Salary {
	...
	public String toString() {
		return "Salary [basicSalary=" + basicSalary + ", hra=" + hra + ", conveyenceAllowance=" + conveyenceAllowance
				...
				+ ", netSalary=" + netSalary + ", calculateTaxableAmount=" + calculateTaxableAmount + "]";
	}
	...
	public Salary(double basicSalary, double epf, double companyPf)
		...
		this.calculateTaxableAmount = calculateTaxableAmount;
	}
	...
	public double getCalculateTaxableAmount() {
		return calculateTaxableAmount;
	}

	public void setCalculateTaxableAmount(double calculateNonTaxableAmount) {
		this.calculateTaxableAmount = calculateNonTaxableAmount;
	}
