...
<body>
    ...
    <div class="dropdown-content">
      <a href="CreatePlan.jsp">Create Plan</a>
      <a href="ChangePlan.jsp">Change Plan</a>
      <a href="PlanDetails.jsp">Show Plan Details</a>
	  <a href="AllPlanDetails.jsp">Show All Plans</a>
    </div>
  </div> 
    		<div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="OpenPostpaidAccount.jsp">Open Postpaid Account</a>
      <a href="SinglePostpaidDEtails.jsp">Single Postpaid Details</a>
      <a href="AllPostpaidDetails.jsp">All Postpaid Details</a>
    </div>
  </div> 
		<div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="ShaowAllBill.jsp">Show All Bill</a>
    </div>
  </div> 
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="ShowCustomerDetails.jsp">Show Customer Details</a>
...
<div  class="form">
		...
		<table>
				<form:form action="registerAssociate" method="post" modelAttribute="associate">
					<tr>
							<td>First Name</td>
							<td><i class="fa fa-user icon"></i><form:input path="firstName" placeHolder="Monthly Rent" size="30"/></td>
